              ...
              <div>
                <div className='recording-top'>
                  <h6 className='int-status'>
                    <span className='active'></span> Live
                  </h6>
            ...
            <div className='interviews-right'>
              ...
              <div className='response-tip mb-3'>
                <div className='mb-4'>
                  <h3>Response Tip:</h3>
                  <p>
                    As you answer, try to give your audience a picture of what
                    you were like day to day. You might share a few words people
                    used to describe you, and a simple example that shows those
                    traits in action
                  </p>
                </div>
...
export default MyInterviewsUpdated;
